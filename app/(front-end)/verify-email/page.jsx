...
export default function VerifyMail() {
  return (
    <div className="max-w-2xl mx-auto min-h-screen  justify-center mt-8">
      <div
      ...
      >
        ...
        <div className="mt-2 mb-4 text-sm">
          Thank you for creating an account with us,we have sent you an
          email,check in your inbox and click on the link to complete your
          onboarding process
        </div>
      </div>
    </div>
