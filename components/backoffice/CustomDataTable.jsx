...
export default function CustomDataTable() {
  ...
  return (
    <div className="p-6">
      <h2 className="text-xl font-bold mb-4 dark:text-slate-50 text-slate-800  mt-8 px-4">
        Recent Orders
      </h2>
      <div className="p-8">
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg ">
          ...
          >
            <span className="text-xl  font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">
              Showing
              <span className="font-semibold text-white dark:text-white ml-1 mr-1">
                {itemStartIndex}-{itemEndIndex}
              </span>
              of
              <span className="font-semibold text-white dark:text-white ml-1">
                {data?.length}
              </span>
            </span>
              ...
              {Array.from({ length: PAGE_SIZE }, (_, index) => (
                <li key={index}>
                  <button
                    ...
                    className={
                      currentPage === index + 1
                        ? "flex items-center justify-center px-3 h-10 leading-tight text-gray-50 bg-blue-600 border border-blue-300 hover:bg-blue-800 hover:text-white-700 dark:bg-slate-300 dark:border-slate-400 dark:text-slate-800 dark:hover:bg-slate-300 "
