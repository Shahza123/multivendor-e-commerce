  ...
  return (
    <nav className="flex  text-sm md:text-xl mb-8">
      ...
      >
        <li>
          <div className="-m-1">
            <p className="inline-flex items-center dark:hover:text-lime-500 text-sm md:text-base p-1   font-medium text-gray-500 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700">
              Cart
                ...
                <div className="-m-1">
                  <p
                    className={`p-1 ml-1.5 text-sm md:text-base font-medium  text-gray-500 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 ${
                      item.number === currentStep ? "text-lime-400" : ""
                    }`}
                  >
                    {item.title}
                  </p>
