  ...
  return (
    <div>
      {isLoading ? (
        ...
        <button
          type="submit"
          className="mt-6   text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-lime-600 dark:hover:bg-lime-700 dark:focus:ring-lime-800"
        >
